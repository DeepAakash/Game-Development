    ...
    for i, bol in pairs(self.ball) do
        for k, brick in pairs(self.bricks) do
            ...
            if brick.inPlay and bol:collides(brick) then
                ...
                if math.random(1, 10) == 5 and #self.ball < 12 then
                ...
                elseif lockedBrick == true and math.random(1, 6) == 3 and self.keys < 5 then
                    table.insert(self.powerup, Powerup(brick.x, brick.y, 10)) 
                elseif lockedBrick == true and math.random(1, 11) == 2  then
                ...
                if self.score > self.recoverPoints and self.score < self.recoverPoints + 1000 then
                ...
                if self.score > self.paddlePoints then
                    ...
                    self.paddlePoints = math.min(120000, self.paddlePoints + 5000)
                    gSounds['recover']:play()
                end
